...
local valid_metals_settings = {
  ...
  "gradleScript",
	"inlayHints.inferredTypes.enable",
	"inlayHints.implicitArguments.enable",
	"inlayHints.implicitConversions.enable",
	"inlayHints.typeParameters.enable",
	"inlayHints.hintsInPatternMatch.enable",
